...
many shaders(even top rated) on Shadertoy use clamp/pow/(/0)/...etc, that work in not same way in OpenGL and webbrowser Angle/GLES, black screen because of this. Also remember to set Alpha in main.glsl when recording rgba video.
