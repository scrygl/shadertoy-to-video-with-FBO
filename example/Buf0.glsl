...
#define iChannel2 u_channel1
#define iChannel3 iTexture0
// line 112 iChannelResolution[3] to iTextureResolution[0]
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec4 noise = texture(iChannel3, fragCoord.xy / iTextureResolution[0].xy + fract(vec2(42,56)*iTime));
